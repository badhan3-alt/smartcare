...
urlpatterns = [
    ...
    path('dashboard/today-patients/', views.doctor_today_patients_view, name='today_patients'),
    path('dashboard/waiting-patients/', views.doctor_waiting_patients_view, name='waiting_patients'),
    path('dashboard/completed-consultations/', views.doctor_completed_consultations_view, name='completed_consultations'),
    path('dashboard/workload/', views.doctor_workload_view, name='workload'),
